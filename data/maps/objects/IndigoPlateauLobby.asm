	...
	const_export INDIGOPLATEAULOBBY_CLERK_TM1
	const_export INDIGOPLATEAULOBBY_CLERK_TM2
...
IndigoPlateauLobby_Object:
	...
	object_event  0,  5, SPRITE_CLERK, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_CLERK_TM1
	object_event  0,  7, SPRITE_CLERK, STAY, RIGHT, TEXT_INDIGOPLATEAULOBBY_CLERK_TM2

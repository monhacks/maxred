	...
	const_export ROCKTUNNELB1F_TM_ROCK_SLIDE
...
RockTunnelB1F_Object:
	...
	warp_event 23,  7, ROCK_TUNNEL_B2F, 1
	warp_event 17, 21, ROCK_TUNNEL_B2F, 2
	warp_event  9,  3, ROCK_TUNNEL_B2F, 3
	warp_event  5, 21, ROCK_TUNNEL_B2F, 4

	def_bg_events

	def_object_events
	object_event 18,  2, SPRITE_COOLTRAINER_F, STAY, DOWN, TEXT_ROCKTUNNELB1F_COOLTRAINER_F1, OPP_JR_TRAINER_F, 9
	object_event 12, 18, SPRITE_HIKER, STAY, DOWN, TEXT_ROCKTUNNELB1F_HIKER1, OPP_HIKER, 9
	...
	object_event  2, 30, SPRITE_POKE_BALL, STAY, NONE, TEXT_ROCKTUNNELB1F_TM_ROCK_SLIDE, TM_ROCK_SLIDE

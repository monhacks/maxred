	...
	const_export SAFARIZONEEAST_TM_X_SCISSOR
...
SafariZoneEast_Object:
	...
	warp_event 24,  0, SAFARI_ZONE_NORTHEAST, 1
	warp_event 25,  0, SAFARI_ZONE_NORTHEAST, 2
	...
	object_event 15, 12, SPRITE_POKE_BALL, STAY, NONE, TEXT_SAFARIZONEEAST_TM_X_SCISSOR, TM_X_SCISSOR

	...
	const_export VERMILIONMART_CLERK_TM
...
VermilionMart_Object:
	...
	object_event  0,  3, SPRITE_CLERK, STAY, RIGHT, TEXT_VERMILIONMART_CLERK_TM
	object_event  5,  6, SPRITE_COOLTRAINER_M, STAY, NONE, TEXT_VERMILIONMART_COOLTRAINER_M
	object_event  4,  2, SPRITE_COOLTRAINER_F, WALK, LEFT_RIGHT, TEXT_VERMILIONMART_COOLTRAINER_F

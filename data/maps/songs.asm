MapSongBanks::
	...
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; ROCK_TUNNEL_B2F
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_NORTHEAST
	db MUSIC_SAFARI_ZONE, BANK(Music_SafariZone) ; SAFARI_ZONE_NE_REST_HOUSE
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_1F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_B1F
	db MUSIC_DUNGEON3, BANK(Music_Dungeon3) ; VICTORY_ROAD_OAKS_ROOM

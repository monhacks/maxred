MoveSoundTable:
	...
	db SFX_NOT_VERY_EFFECTIVE, $10, $c0 ; DRAGON_DANCE
	db SFX_FAINT_FALL,         $ff, $04 ; SHADOW_PUNCH
	...
	db SFX_BATTLE_28,          $40, $80 ; ICICLE_SPEAR
	db SFX_BATTLE_29,          $f0, $e0 ; SHEER_COLD
	db SFX_BATTLE_09,          $20, $c0 ; BULK_UP
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; AERIAL_ACE
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; AIR_CUTTER
	db SFX_NOT_VERY_EFFECTIVE, $10, $c0 ; FEATHERDANCE
	...
	db SFX_BATTLE_35,          $11, $18 ; FAKE_TEARS
	db SFX_BATTLE_0E,          $20, $20 ; IRON_DEFENSE
	db SFX_BATTLE_13,          $00, $e0 ; OMINOUS_WIND
	db SFX_BATTLE_25,          $00, $10 ; SHADOW_SNEAK
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; X_SCISSOR
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; CROSS_POISON
	db SFX_BATTLE_2A,          $20, $20 ; GUNK_SHOT
	db SFX_BATTLE_18,          $00, $80 ; HEAD_SMASH
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; STONE_EDGE
	db SFX_BATTLE_22,          $00, $80 ; POWER_WHIP
	db SFX_BATTLE_34,          $00, $40 ; SEED_BOMB
	db SFX_PSYBEAM,            $00, $80 ; CHARGE_BEAM
	db SFX_BATTLE_29,          $f0, $e0 ; ICE_SHARD
	db SFX_NOT_VERY_EFFECTIVE, $00, $a0 ; AIR_SLASH
	db SFX_BATTLE_18,          $00, $80 ; ZEN_HEADBUTT
	db SFX_DOUBLESLAP,         $00, $80 ; DOUBLE_HIT
	db SFX_BATTLE_20,          $00, $80 ; ROCK_CLIMB
	db SFX_BATTLE_25,          $00, $10 ; AQUA_JET
	db SFX_BATTLE_35,          $11, $18 ; DARK_PULSE
	db SFX_BATTLE_09,          $f8, $10 ; NASTY_PLOT
	db SFX_NOT_VERY_EFFECTIVE, $01, $ff ; NIGHT_SLASH
	db SFX_BATTLE_25,          $00, $10 ; BULLET_PUNCH
	db SFX_BATTLE_18,          $00, $80 ; IRON_HEAD
	db SFX_BATTLE_34,          $00, $40 ; MAGNET_BOMB
	db SFX_NOT_VERY_EFFECTIVE, $10, $c0 ; QUIVER_DANCE
	db SFX_BATTLE_0D,          $10, $60 ; FLAME_CHARGE
	db SFX_BATTLE_29,          $1f, $20 ; INFERNO
	db SFX_BATTLE_13,          $00, $e0 ; HURRICANE
	db SFX_BATTLE_33,          $80, $40 ; AUTOTOMIZE
	db SFX_BATTLE_35,          $11, $18 ; BABYDOLLEYES
	db SFX_BATTLE_0B,          $00, $c0 ; DISARM_VOICE
	db SFX_BATTLE_09,          $88, $10 ; DRAININGKISS
	db SFX_BATTLE_12,          $00, $c0 ; FAIRY_WIND
	db SFX_NOT_VERY_EFFECTIVE, $f0, $e0 ; MOONBLAST
	db SFX_BATTLE_0D,          $00, $40 ; POWERUPPUNCH
	db SFX_BATTLE_19,          $21, $e0 ; MYSTIC_FIRE
	db SFX_SUPER_EFFECTIVE,    $10, $a0 ; TRAILBLAZE
	db SFX_BATTLE_24,          $20, $60 ; CHILLINWATER
	db SFX_BATTLE_0F,          $1f, $ff ; RAZOR_SHELL
	db SFX_BATTLE_0D,          $00, $a0 ; VOLT_TACKLE
	db SFX_BATTLE_22,          $00, $80 ; POISON_TAIL
	db SFX_BATTLE_26,          $01, $60 ; VITAL_THROW
	db SFX_BATTLE_0D,          $00, $a0 ; WILD_CHARGE

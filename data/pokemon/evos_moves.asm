...
Porygon2EvosMoves:
; Evolutions
	db EVOLVE_ITEM, DUBIOUS_DISC, 1, PORYGON_Z
	db 0
; Learnset
	db 0
...
SneaselEvosMoves:
; Evolutions
	db EVOLVE_ITEM, RAZOR_CLAW, 1, WEAVILE
	db 0
; Learnset
	db 0

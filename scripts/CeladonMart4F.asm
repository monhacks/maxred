...
CeladonMart4FClerkText:
	script_mart POKE_DOLL, FIRE_STONE, THUNDER_STONE, WATER_STONE, LEAF_STONE, MOON_STONE, SUN_STONE, DUSK_STONE, SHINY_STONE, ICE_STONE, KINGS_ROCK, METAL_COAT, DRAGON_SCALE, UPGRADE, DUBIOUS_DISC